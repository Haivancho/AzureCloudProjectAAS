<%@ Page Title="Grade CreateNew" Language="C#" MasterPageFile="~/Site.Master"
AutoEventWireup="true" CodeBehind="GradeCreateNew.aspx.cs"
Inherits="ProjectAAS.GradeCreateNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <h1>Grade</h1>
 FNumber
 <br />
 <asp:TextBox ID="TextBoxStudentFNumber" runat="server" />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required" ControlToValidate="TextBoxStudentFNumber" ForeColor="Red"></asp:RequiredFieldValidator>
 <br />
 Subject
 <br />
