...
namespace ProjectAAS
{
    public class Configurator
    {
        ...
        public DataTable LoadSpecialties()
        {
            ...
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
            command.CommandText = "SELECT * FROM Specialty ORDER BY SpecialtyId ASC";
            SqlDataReader reader = command.ExecuteReader();
            using (reader)
            {
                while (reader.Read())
        ...
        public void InsertSpecialty(string id, string name)
        {
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
        ...
        public DataTable LoadSubjects()
        {
            ...
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
            command.CommandText = "SELECT * FROM Subject ORDER BY SubjectId ASC";
            SqlDataReader reader = command.ExecuteReader();
            using (reader)
            {
                while (reader.Read())
        ...
        public DataTable LoadStudents()
        {
            ...
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
            command.CommandText = "SELECT * FROM Student JOIN Specialty ON Student.SpecialtyId = Specialty.SpecialtyId ORDER BY FNumber ASC";
            SqlDataReader reader = command.ExecuteReader();
            using (reader)
            {
                while (reader.Read())
        ...
        public void UpdateStudent(string fNumber, int specialtyId, string fName, string mName, string lName, string address, string phone, string eMail)
        {
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
        ...
        public void InsertStudent(string fNumber, int specialtyId, string fName, string mName, string lName, string address, string phone, string eMail)
        {
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
        ...
        public DataTable LoadGrades()
        {
            ...
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
            command.CommandText = "SELECT * FROM StudentSubject JOIN Student ON StudentSubject.FNumber = Student.FNumber JOIN Subject ON StudentSubject.SubjectId = Subject.SubjectId";
            SqlDataReader reader = command.ExecuteReader();
            using (reader)
            {
                while (reader.Read())
                {
                    ...
                    string finalGrade = Convert.ToString(reader["FinalGrade"]);
                    DataRow row = result.NewRow();
                    row[0] = fNumber;
                    row[1] = subjectName;
                    row[2] = finalGrade;
        ...
        public Grade LoadGradeByFNumber(string fNumber)
        {
            Grade result = null;
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            ...
            using (reader)
            {
                if (reader.Read())
                {
                    ...
                    result.FinalGrade = Convert.ToInt32(finalGrade);
                }
            }
            connection.Close();
            return result;
        }
        public void UpdateGrade(string fNumber, int subjectId, string finalGrade)
        {
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
            command.CommandText = "UPDATE StudentSubject SET FinalGrade = @FinalGrade";
            SqlParameter param = null;
            param = new SqlParameter("@FNumber", SqlDbType.VarChar);
            param.Value = fNumber;
            command.Parameters.Add(param);
        ...
        public void InsertGrade(string fNumber, int subjectId, string finalGrade)
        {
            SqlConnection connection = this.manipulator.GetConnection();
            connection.Open();
            SqlCommand command = this.manipulator.GetCommand();
